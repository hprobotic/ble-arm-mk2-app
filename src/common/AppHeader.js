/*
* @Author: Tuan PM
* @Date:   2016-05-23 20:07:40
* @Last Modified by:   TuanPM
* @Last Modified time: 2016-05-23 20:11:17
*/
...
class AppHeaderIOS extends React.Component {
  ...
  render() {
    ...
    const titleColor = foreground === 'dark' ? AppColors.darkText : 'white';
    const itemsColor = foreground === 'dark' ? AppColors.lightText : 'white';
